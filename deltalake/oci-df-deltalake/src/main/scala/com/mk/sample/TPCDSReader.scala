...
object TPCDSReader extends App{
  ...
  val lines =
    Source.fromFile("/Users/mlln/OCI/temp/TPC-DS_SF1000-run3.log")
      .getLines()
  ...
  lines.foreach(line =>
  {
    ...
    val difference_In_Minutes = (difference_In_Time / (1000 * 60) % 60)
      ...
      //        println("startDate:"+ startDate+" endDate:"+endDate+" difference:"+(difference_In_Minutes*60+difference_In_Seconds))
